      ...
      <body>
       ...
       <div style="display: flex;justify-content: space-between;align-items: center;">
               ...
               <input class="inputglobal" value="{{$producto->codigodebarra}}"  name="codigodebarra" type="text">

                        </div>

   <div style="display: flex;justify-content: space-between;align-items: center;">
                          Descripción</span> <input type="text" value="{{$producto->descripcion}}" name="descripcion"  class="inputglobal">
                        </div>

                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            Se vende<input value="{{$producto->sevende}}"  name="sevende"  type="text" class="inputglobal"></div>

                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            Precio Costo<input value="{{$producto->preciocosto}}"  name="preciocosto"  type="text" class="inputglobal"></div>

                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            Precio Venta<input value="{{$producto->precioventa}}"  name="precioventa" type="text" class="inputglobal"></div>

                        <div
                            style="display: flex;justify-content: space-between;align-items: center;">
                            Precio Mayoreo<input value="{{$producto->preciomayoreo}}"  name="preciomayoreo" type="text" class="inputglobal"></div>
