      ...
      <body>
        <div class="contenedor">
          ...
          <main class="contenido">
            ...
            <!-- Fila 1-->
            <div class="botones" style="display: flex;justify-content: space-between; flex-wrap:wrap; box-sizing: border-box;">
          ...
          <div id="contenedorinventario"> 
            <div class="contenedorh6">
                    <h6>Departamento</h6>   
                </div>

            <!--Select desde departamento -->
                <select  class="selector" id="country" name="country" >
                  ...
                  @endforeach
                        ...
                        <a class="ancla modal-trigger" href="#agregarinventario">
                            <i class="material-icons"> fiber_new</i>Agregar</a>
            
                <!--  agregarInventario Modal Structure -->
                <div id="agregarinventario" class="modal">
                  ...
                  <form action="{{url('/inventario')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                      Descripción
                      <input type="text" name="descripcion" class="inputglobal">
                    </div>

                    <div>
                        Cantidad Actual
                        <input name="cantidadactual" type="text" class="inputglobal">
                      </div>
           


                    <div>
                        Cantidad<input name="cantidad" type="text" class="inputglobal"></div>
                        ...
                        <a class="ancla modal-trigger" href="#ajustarinventario" >
                            <i class="material-icons">close</i>Ajustar</a>

                                  <!-- Ajustar inventario Modal Structure -->
                <div id="ajustarinventario" class="modal">
                  <h5>
                       
                    <i class="material-icons orange-text"
                          style="font-size:30px ;margin-right: 10px;">create
                      </i> Ajustar inventario
                  </h5>
                  ...
                  <div>
                      Cantidad Actual<input id="" type="text" class="inputglobal"></div>
            ...
            <div class="despliegueInfo">
                ...
                <table>
                    ...
                    <tr>
                        <td>{{$inventario->codigodebarra}}</td>
                        <td>{{$inventario->descripcion}}</td>
                        <td>{{$inventario->preciocosto}}</td>
                        <td>{{$inventario->precioventa}}</td>
                        <td>{{$inventario->cantidad}}</td>
                        <td>
                          <a href="{{url('/inventario/'.$inventario->id.'/edit')}}">
                            Ajustar
                          </a>
                          ...
                          {{csrf_field()}}
                          {{method_field('DELETE')}}
                          <button type="submit" onclick="return confirm('¿Seguro deseas eliminar este inventario?')">Eliminar</button>
                          </form>
            ...
            <div style=" display:flex; justify-content: flex-end;align-items: center;">
               ...
               href="#nuevocliente"
                ...
                <i style="padding-right: 4px; color:green;" class="material-icons">
                    file_download </i> Exportar desde excel</a>
