      ...
      <main class="contenido">
        <div class="row">
          <div style="width:80%">
            ...
            <!-- Fila 1-->
            <div
              style="display: flex;justify-content: space-between; flex-wrap:wrap; box-sizing: border-box;"
            >
              ...
              <div style="width:48%;">
                <!-- Respaldo automático -->
                <a href="#respaldo" class="modal-trigger ancla"
                  ><i class="material-icons"> save_alt</i>Respaldo automático</a
                >
              </div>

              <div style="width:48%;">
                <!-- licencia Trigger -->
                <a href="licencia.html" class="ancla"
                  ><i class="material-icons"> class</i>Licencia</a
                >
              </div>
            </div>
            ...
            <div class="row">
              <div class="col m5">
                <h5>Licencia del Sistema</h5>
              </div>

              <div class="input-field col m12">
                Si deseas mover el programa y su licencia a otra computadora por
                favor haz clic en el siguiente botón y sigue el procedimiento:

                <div class="input-field col m6" style="padding: 0;">
                  <!--  Trigger -->
                  <a href="#" class="ancla"
                    ><i class="material-icons"> laptop_windows</i>Mover licencia
                    a otra pc</a
                  >
                </div>
              </div>
