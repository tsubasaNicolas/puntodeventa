      ...
      <body>
        <div class="contenedor">
          ...
          <main class="contenido">
            ...
            <!--Hacerr corte de hoy -- imprimir corte-->
      
            <div style="margin-top:0">
              <h3 style="margin:1%; font-size: 24px;">Corte del día</h3>
            </div>
            <!-- Botones-->
            <div class="opcionescorte">
      
              <a class="ancla">
                <i class="material-icons">content_cut</i>
                Hacer corte de hoy</a>
            ...
            <div class="corteitem">
              ...
              <div class="seccioncorte">
                <h5>Entradas de efectivo</h5>
                <p>
                  Entradas de dinero (Cambio):
                </p>
                <p>
