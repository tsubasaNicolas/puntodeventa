...
<body>
  <div class="contenedor">
    ...
    <main class="contenido">
      <!-- Fila 1-->
      <div style="display: flex;justify-content: space-between; flex-wrap:wrap; box-sizing: border-box;">
        ...
        <!--editar Cliente-->
        <div style="width:35%;">
          <a href="#modificarcliente" class="modal-trigger ancla"><i class="material-icons">
              create</i>Editar</a>
        </div>


        <!--  editar Cliente modificarcliente Modal Structure -->
        <div id="modificarcliente" class="modal">
       ...
       <form method="POST" action="">
          ...
          <div style="display: flex;justify-content: space-between;align-items: center;">
            Razón Social
          <input value="" class="inputglobal" type="text">
          </div>

          <div style="display: flex;justify-content: space-between; align-items: center;">
            RUT<input type="text" class="inputglobal">
          </div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Dirección<input id="" type="text" class="inputglobal"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Comuna<input id="" type="text" class="inputglobal"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Ciudad<input id="" type="text" class="inputglobal"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Giro<input id="" type="text" class="inputglobal"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Teléfono<input id="" type="text" class="inputglobal"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            E-mail<input id="" type="text" class="inputglobal"></div>
        ...
        <div style="width:35%;">
          ...
          <!-- eliminar cliente Modal Structure -->
          <div id="eliminarcliente" class="modal">

            <h5><strong>¿Seguro que desea eliminar al cliente?</strong></h5>
      ...
      <div class="despliegueInfo">
        <table>
          ...
          <td>{{$cliente->id}}</td>
            ...
            {{csrf_field()}}
            {{method_field('DELETE')}}
            <button type="submit" onclick="return confirm('¿Seguro deseas eliminar este cliente?')">Eliminar</button>
            </form>
      ...
      <!-- nuevo cliente s/códito Trigger -->

      <div style=" display:flex; justify-content: flex-end;align-items: center;">
        <a id="agregarcliente" href="#nuevocliente" class="modal-trigger">
          <i class="material-icons">add</i></a>

        <!--  nuevo cliente s/códito Modal Structure -->
        <div id="nuevocliente" class="modal">

        <form action="{{url('/clientes')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}

          <h5 style="margin-top: 10px;display: flex;justify-content: center;
                         align-items: center;text-align: center;">
            <i class="material-icons orange-text" style="font-size:30px ;margin-right: 10px;">fiber_new
            </i> Nuevo Cliente
          </h5>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Razón Social 
            <input class="inputglobal" type="text" name="razonsocial">
          </div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            RUT<input type="text" class="inputglobal" name="rut">
          </div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Dirección<input id="" type="text" class="inputglobal" name="direccion">
          </div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Comuna<input id="" type="text" class="inputglobal" name="comuna"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Ciudad<input id="" type="text" class="inputglobal" name="ciudad"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Giro<input id="" type="text" class="inputglobal" name="giro"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            Teléfono<input id="" type="text" class="inputglobal" name="telefono"></div>

          <div style="display: flex;justify-content: space-between;align-items: center;">
            E-mail<input id="" type="text" class="inputglobal" name="email"></div>
