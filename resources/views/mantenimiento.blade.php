      ...
      <body>
        ...
        <main class="contenido">
            ...
            <!--botones-->
              ...
              <div class="opcionesmantenimiento">

                <a class="ancla">
                  <i class="material-icons">
                create</i>Respaldo automático</a>

                   <!-- licencia Trigger -->
                   <a class="ancla" href="licencia.html">
                    <i class="material-icons">
                       close</i>Licencia</a>
                </div>  
        </div>
           ...
           <div style="width: 100%;display: flex;justify-content:flex-start;">
              ...
              <div style="margin-left:20px">
                ...
                Por favor, especifique la ruta/unidad de su memoria USB o unidad de red en la que desea hacer un respaldo de la base de datos:
            </p>
                  <div style="margin-top:10px; padding-right: 10px;">
                    <input  id="inputmantenimiento" type="text" >

                </div>
               <div style="margin-top:10px;display: flex;align-items: center;">
                <input type="checkbox" checked="checked">
               <span style="margin-left: 10px;font-size: 14px;">Realizar respaldo automático al salir del programa.</span>
                    </div>
        ...
        <div style="width: 100%; margin-top:10px; display: flex;justify-content:flex-start;">
            <div style="margin-left:20px">
        <p id="comorestaurar"><strong> ¿Cómo restaurar mi base de datos?</strong></p>
        <p style="margin-top:10px;font-size: 14px;">Para restaurar una base de datos respaldada sólo haga doble clic en el archivo de respaldo para que se restaure.</p>
