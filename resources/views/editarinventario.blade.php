        ...
        <div class="contenedor">
          <header class="header" style="padding-top: 0;padding-left:0px;padding-right: 0; 
            ...
            <div  style="display: flex;justify-content: center; ">
                ...
                <div id="ajustarinventario" class="" style="width: 100%">
                  <h5>
                  ...
                  <div>
                     Código de barras
                      <input class="inputglobal" value="{{$inventario->codigodebarra}}"  name="codigodebarra" type="text">
                  </div>

                  <div>
                    Descripción
                    <input type="text" class="inputglobal" value="{{$inventario->descripcion}}"  name="descripcion">
                  </div>

                  <div>
                      Cantidad Actual<input type="text" value="{{$inventario->cantidadactual}}"  name="cantidadactual" class="inputglobal"></div>


                  <div>
                      Cantidad<input value="{{$inventario->cantidad}}"  name="cantidad" type="text" class="inputglobal"></div>
